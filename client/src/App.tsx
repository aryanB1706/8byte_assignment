...
function App() {
  ...
  if (error) return <div className="p-10 text-center text-red-600">Error: {error} <button onClick={refetch} className="ml-3 text-sm underline">Retry</button></div>
  if (!data) return null
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-10">
        <PortfolioTable holdings={holdings} onRetry={refetch} />
